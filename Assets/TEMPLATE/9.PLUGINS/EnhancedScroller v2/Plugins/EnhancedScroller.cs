...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        #region Public
        ...
        /// </summary>
        public bool forceSnapOnPointerUp;
        ...
        /// </summary>
        public CustomTweenFunction customTweenFunction;
        ...
        public void OnPointerUp(PointerEventData data)
        {
            ...
            // only snap if it is forced, we have snapping set, and the linear velocity is almost zero
            if (forceSnapOnPointerUp && snapping && Mathf.Abs(LinearVelocity) < 1.0f)
            {
        ...
        public void OnEndDrag(PointerEventData data)
		{
            ...
            if (forceSnapOnEndDrag && snapping && _dragPreviousPos == data.position && !_snapJumping)
            {
                Snap();
            }
        }
                ...
                while (_tweenTimeLeft < time && !_interruptTween)
                {
                    if (!tweenPaused)
                    {
                        ...
                        switch (tweenType)
                        {
                            ...
                            case TweenType.custom: newPosition = (customTweenFunction == null ? linear(start, end, (_tweenTimeLeft / time)) : customTweenFunction(start, end, (_tweenTimeLeft / time))); break;
                        }
