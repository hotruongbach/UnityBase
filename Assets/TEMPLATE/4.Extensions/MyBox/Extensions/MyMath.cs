...
namespace MyBox
{
	...
	{
        public static Vector3 Parabol(Vector3 start, Vector3 end, float height, float t)
        {
        ...
        public static Vector2 Parabol(Vector2 start, Vector2 end, float height, float t)
        {
            Func<float, float> f = x => -4 * height * x * x + 4 * height * x;
