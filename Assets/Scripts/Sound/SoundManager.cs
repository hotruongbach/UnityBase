...
public class SoundManager : MonoBehaviour
{
    ...
    private void Start()
    {
        musicSource.enabled = PlayerPrefsManager.Music;
    ...
    {
        EventDispatcher.Instance.RemoveListener(EventID.OnSoundChangeValue, OnSoundChangeValue);
        EventDispatcher.Instance.RemoveListener(EventID.OnMusicChangeValue, OnMusicChangeValue);
    }
